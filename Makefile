...
XTRA_OBJS = 
abs_builddir = /home/sivaprakash/Documents/squid-3.4.6/src/log
abs_srcdir = /home/sivaprakash/Documents/squid-3.4.6/src/log
...
include ./$(DEPDIR)/CustomLog.Plo
include ./$(DEPDIR)/File.Plo
include ./$(DEPDIR)/FormatHttpdCombined.Plo
include ./$(DEPDIR)/FormatHttpdCommon.Plo
include ./$(DEPDIR)/FormatSquidCustom.Plo
include ./$(DEPDIR)/FormatSquidIcap.Plo
include ./$(DEPDIR)/FormatSquidNative.Plo
include ./$(DEPDIR)/FormatSquidReferer.Plo
include ./$(DEPDIR)/FormatSquidUseragent.Plo
include ./$(DEPDIR)/ModDaemon.Plo
include ./$(DEPDIR)/ModStdio.Plo
include ./$(DEPDIR)/ModSyslog.Plo
include ./$(DEPDIR)/ModUdp.Plo
include ./$(DEPDIR)/TcpLogger.Plo
